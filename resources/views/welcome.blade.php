                ...
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                  ...
                  <br>
                    <ul style="color: white">
                        ...
                        <li>User can Get All Blog <a href="" style="color: green;">[http://localhost:8000/api/posts] <b>GET</b> </a></li>
                        <li>User can Update  Blog <a href="" style="color: green;">[http://localhost:8000/api/posts/{id}] <b>PUT</b></a></li>
                        <li>User can Delete  Blog <a href="" style="color: rgb(139, 12, 12);">[http://localhost:8000/api/posts/{id}] <b>DELETE</b></a></li>
                    </ul>
